...
<body>
	<jsp:useBean id="lista"
		...
		scope="request" />
	<div id="center">
		<h1>Cursos em andamento por professor</h1>
		<hr>
		<table class="table table-striped table-hover ">
			...
			<tbody>
				<c:forEach var="curso" items="${lista.listCursoEmAndamentoPorProfessor}">
					<tr>
						<td align="center"><a
							href="DetalhesCurso?codigo=${curso.cdcurso}">${curso.decurso}</a></td>
