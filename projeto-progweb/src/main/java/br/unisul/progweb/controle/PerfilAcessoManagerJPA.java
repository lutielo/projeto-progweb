...
public class PerfilAcessoManagerJPA extends HttpServlet {
	...
	private void processaRequisicao(HttpServletRequest request,	HttpServletResponse response) throws ServletException, IOException {
		...
		PerfilacessoId myPerfilAcessoId = new PerfilacessoId((short) 0, "/all");
		//Perfil myPerfil = new Perfil();
		//Perfilacesso perfilacesso = new Perfilacesso(myPerfilAcessoId, myPerfil);
		
		perfilAcessoDAO.inserir(myPerfilAcessoId);
